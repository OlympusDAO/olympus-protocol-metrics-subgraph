...
function getMV_RFV(blockNumber: BigInt): BigDecimal[]{
    ...
    let feiERC20 = ERC20.bind(Address.fromString(FEI_ERC20_CONTRACT))
    ...
    let feiBalance = feiERC20.balanceOf(Address.fromString(TREASURY_ADDRESS_V3))
    ...
    let stableValue = daiBalance.plus(fraxBalance).plus(lusdBalance).plus(ustBalance).plus(feiBalance)
