...
export const FEI_ERC20_CONTRACT = "0x956F47F50A910163D8BF957Cf5846D573E7f87CA";

export const TRIBE_ERC20_CONTRACT = "0xc7283b66Eb1EB5FB86327f08e1B5816b0720212B";
...
CONTRACT_STARTING_BLOCK_MAP.set(OHMV2_ERC20_CONTRACT, OHMV2_ERC20_CONTRACT_BLOCK);
CONTRACT_STARTING_BLOCK_MAP.set(SOHM_ERC20_CONTRACTV2, SOHM_ERC20_CONTRACTV2_BLOCK);
CONTRACT_STARTING_BLOCK_MAP.set(SOHM_ERC20_CONTRACTV3, SOHM_ERC20_CONTRACTV3_BLOCK);
CONTRACT_STARTING_BLOCK_MAP.set(UST_ERC20_CONTRACT, UST_ERC20_CONTRACT_BLOCK);
CONTRACT_STARTING_BLOCK_MAP.set(LUSD_ERC20_CONTRACT, LUSD_ERC20_CONTRACTV2_BLOCK);
CONTRACT_STARTING_BLOCK_MAP.set(CVX_ERC20_CONTRACT, CVX_ERC20_CONTRACT_BLOCK);
CONTRACT_STARTING_BLOCK_MAP.set(VLCVX_ERC20_CONTRACT, VLCVX_ERC20_CONTRACT_BLOCK);
CONTRACT_STARTING_BLOCK_MAP.set(FXS_ERC20_CONTRACT, FXS_ERC20_CONTRACT_BLOCK);
CONTRACT_STARTING_BLOCK_MAP.set(VEFXSERC20_CONTRACT, VEFXSERC20_BLOCK);
...
CONTRACT_NAME_MAP.set(OHM_ERC20_CONTRACT, "OHM ERC20 V1");
CONTRACT_NAME_MAP.set(OHMV2_ERC20_CONTRACT, "OHM ERC20 V2");
CONTRACT_NAME_MAP.set(SOHM_ERC20_CONTRACT, "sOHM ERC20");
CONTRACT_NAME_MAP.set(SOHM_ERC20_CONTRACTV2, "sOHM ERC20 V2");
CONTRACT_NAME_MAP.set(SOHM_ERC20_CONTRACTV3, "sOHM ERC20 V3");
CONTRACT_NAME_MAP.set(UST_ERC20_CONTRACT, "UST ERC20");
CONTRACT_NAME_MAP.set(LUSD_ERC20_CONTRACT, "LUSD ERC20");
CONTRACT_NAME_MAP.set(CVX_ERC20_CONTRACT, "CVX ERC20");
CONTRACT_NAME_MAP.set(VLCVX_ERC20_CONTRACT, "vlCVX ERC20");
CONTRACT_NAME_MAP.set(FXS_ERC20_CONTRACT, "FXS ERC20");
CONTRACT_NAME_MAP.set(VEFXSERC20_CONTRACT, "veFXS ERC20");
