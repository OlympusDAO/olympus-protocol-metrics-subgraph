...
export class ETHBondV1__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ETHBondV1__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ETHBondV1__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ETHBondV1 extends ethereum.SmartContract {
  static bind(address: Address): ETHBondV1 {
    return new ETHBondV1("ETHBondV1", address);
  }
  ...
  adjustment(): ETHBondV1__adjustmentResult {
    ...
    return new ETHBondV1__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<ETHBondV1__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new ETHBondV1__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  assetPrice(): BigInt {
    const result = super.call("assetPrice", "assetPrice():(int256)", []);

    return result[0].toBigInt();
  }

  try_assetPrice(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("assetPrice", "assetPrice():(int256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  bondInfo(param0: Address): ETHBondV1__bondInfoResult {
    const result = super.call(
      "bondInfo",
    ...
    return new ETHBondV1__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<ETHBondV1__bondInfoResult> {
    const result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  terms(): ETHBondV1__termsResult {
    ...
    return new ETHBondV1__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<ETHBondV1__termsResult> {
    const result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256)",
      []
