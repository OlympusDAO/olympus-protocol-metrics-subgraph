...
export class OHMFRAXBondV2__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMFRAXBondV2__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMFRAXBondV2__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMFRAXBondV2 extends ethereum.SmartContract {
  static bind(address: Address): OHMFRAXBondV2 {
    return new OHMFRAXBondV2("OHMFRAXBondV2", address);
  }
  ...
  adjustment(): OHMFRAXBondV2__adjustmentResult {
    ...
    return new OHMFRAXBondV2__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<OHMFRAXBondV2__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new OHMFRAXBondV2__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): OHMFRAXBondV2__bondInfoResult {
    const result = super.call(
      "bondInfo",
    ...
    return new OHMFRAXBondV2__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<OHMFRAXBondV2__bondInfoResult> {
    const result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new OHMFRAXBondV2__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  bondPriceInUSD(): BigInt {
    const result = super.call("bondPriceInUSD", "bondPriceInUSD():(uint256)", []);
  ...
  currentDebt(): BigInt {
    const result = super.call("currentDebt", "currentDebt():(uint256)", []);

    return result[0].toBigInt();
  }

  try_currentDebt(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("currentDebt", "currentDebt():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  debtDecay(): BigInt {
    const result = super.call("debtDecay", "debtDecay():(uint256)", []);

    return result[0].toBigInt();
  }

  try_debtDecay(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("debtDecay", "debtDecay():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  isLiquidityBond(): boolean {
    const result = super.call("isLiquidityBond", "isLiquidityBond():(bool)", []);
  ...
  lastDecay(): BigInt {
    const result = super.call("lastDecay", "lastDecay():(uint256)", []);

    return result[0].toBigInt();
  }

  try_lastDecay(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("lastDecay", "lastDecay():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  policy(): Address {
    const result = super.call("policy", "policy():(address)", []);

    return result[0].toAddress();
  }

  try_policy(): ethereum.CallResult<Address> {
    const result = super.tryCall("policy", "policy():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  principle(): Address {
    const result = super.call("principle", "principle():(address)", []);

    return result[0].toAddress();
  }

  try_principle(): ethereum.CallResult<Address> {
    const result = super.tryCall("principle", "principle():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  redeem(_recipient: Address, _stake: boolean): BigInt {
    const result = super.call("redeem", "redeem(address,bool):(uint256)", [
  ...
  try_redeem(
    ...
    const result = super.tryCall("redeem", "redeem(address,bool):(uint256)", [
      ethereum.Value.fromAddress(_recipient),
      ethereum.Value.fromBoolean(_stake)
    ]);
    if (result.reverted) {
  ...
  stakingHelper(): Address {
    const result = super.call("stakingHelper", "stakingHelper():(address)", []);
  ...
  terms(): OHMFRAXBondV2__termsResult {
    const result = super.call(
      "terms",
    ...
    return new OHMFRAXBondV2__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<OHMFRAXBondV2__termsResult> {
    const result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new OHMFRAXBondV2__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  useHelper(): boolean {
    const result = super.call("useHelper", "useHelper():(bool)", []);

    return result[0].toBoolean();
  }

  try_useHelper(): ethereum.CallResult<boolean> {
    const result = super.tryCall("useHelper", "useHelper():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
