...
export class LUSDAllocatorV2 extends ethereum.SmartContract {
  ...
  FEE_PRECISION(): BigInt {
    const result = super.call("FEE_PRECISION", "FEE_PRECISION():(uint256)", []);
  ...
  POOL_FEE_MAX(): BigInt {
    const result = super.call("POOL_FEE_MAX", "POOL_FEE_MAX():(uint256)", []);

    return result[0].toBigInt();
  }

  try_POOL_FEE_MAX(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("POOL_FEE_MAX", "POOL_FEE_MAX():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  ethToLUSDRatio(): BigInt {
    const result = super.call("ethToLUSDRatio", "ethToLUSDRatio():(uint256)", []);
  ...
  getETHRewards(): BigInt {
    const result = super.call("getETHRewards", "getETHRewards():(uint256)", []);
  ...
  getLQTYRewards(): BigInt {
    const result = super.call("getLQTYRewards", "getLQTYRewards():(uint256)", []);
  ...
  lqtyStaking(): Address {
    const result = super.call("lqtyStaking", "lqtyStaking():(address)", []);

    return result[0].toAddress();
  }

  try_lqtyStaking(): ethereum.CallResult<Address> {
    const result = super.tryCall("lqtyStaking", "lqtyStaking():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  minETHLUSDRate(): BigInt {
    const result = super.call("minETHLUSDRate", "minETHLUSDRate():(uint256)", []);
  ...
  poolFee(): i32 {
    const result = super.call("poolFee", "poolFee():(uint24)", []);

    return result[0].toI32();
  }

  try_poolFee(): ethereum.CallResult<i32> {
    const result = super.tryCall("poolFee", "poolFee():(uint24)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  swapRouter(): Address {
    const result = super.call("swapRouter", "swapRouter():(address)", []);

    return result[0].toAddress();
  }

  try_swapRouter(): ethereum.CallResult<Address> {
    const result = super.tryCall("swapRouter", "swapRouter():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  wethAddress(): Address {
    const result = super.call("wethAddress", "wethAddress():(address)", []);

    return result[0].toAddress();
  }

  try_wethAddress(): ethereum.CallResult<Address> {
    const result = super.tryCall("wethAddress", "wethAddress():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
