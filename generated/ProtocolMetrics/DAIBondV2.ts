...
export class DAIBondV2__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class DAIBondV2__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class DAIBondV2 extends ethereum.SmartContract {
  static bind(address: Address): DAIBondV2 {
  ...
  adjustment(): DAIBondV2__adjustmentResult {
    ...
    return new DAIBondV2__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_adjustment(): ethereum.CallResult<DAIBondV2__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new DAIBondV2__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  bondInfo(param0: Address): DAIBondV2__bondInfoResult {
    const result = super.call(
      "bondInfo",
    ...
    return new DAIBondV2__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<DAIBondV2__bondInfoResult> {
    const result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  redeem(_stake: boolean): BigInt {
    const result = super.call("redeem", "redeem(bool):(uint256)", [
  ...
  try_redeem(_stake: boolean): ethereum.CallResult<BigInt> {
    const result = super.tryCall("redeem", "redeem(bool):(uint256)", [
      ethereum.Value.fromBoolean(_stake)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  setStaking(_staking: Address): boolean {
    const result = super.call("setStaking", "setStaking(address):(bool)", [
  ...
  try_setStaking(_staking: Address): ethereum.CallResult<boolean> {
    const result = super.tryCall("setStaking", "setStaking(address):(bool)", [
      ethereum.Value.fromAddress(_staking)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  terms(): DAIBondV2__termsResult {
    ...
    return new DAIBondV2__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<DAIBondV2__termsResult> {
    const result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256)",
      []
