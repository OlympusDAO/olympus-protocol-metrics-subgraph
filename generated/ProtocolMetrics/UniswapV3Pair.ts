...
export class UniswapV3Pair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV3Pair__collectProtocolResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV3Pair__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class UniswapV3Pair__positionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class UniswapV3Pair__slot0Result {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class UniswapV3Pair__ticksResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class UniswapV3Pair extends ethereum.SmartContract {
  static bind(address: Address): UniswapV3Pair {
    return new UniswapV3Pair("UniswapV3Pair", address);
  }
  ...
  fee(): i32 {
    const result = super.call("fee", "fee():(uint24)", []);

    return result[0].toI32();
  }

  try_fee(): ethereum.CallResult<i32> {
    const result = super.tryCall("fee", "fee():(uint24)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  liquidity(): BigInt {
    const result = super.call("liquidity", "liquidity():(uint128)", []);

    return result[0].toBigInt();
  }

  try_liquidity(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("liquidity", "liquidity():(uint128)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  observations(param0: BigInt): UniswapV3Pair__observationsResult {
    const result = super.call(
      "observations",
  ...
  try_observations(
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV3Pair__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  observe(secondsAgos: Array<BigInt>): UniswapV3Pair__observeResult {
    const result = super.call(
      "observe",
  ...
  positions(param0: Bytes): UniswapV3Pair__positionsResult {
    const result = super.call(
      "positions",
  ...
  try_positions(
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV3Pair__positionsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  try_protocolFees(): ethereum.CallResult<UniswapV3Pair__protocolFeesResult> {
    const result = super.tryCall(
      "protocolFees",
      "protocolFees():(uint128,uint128)",
      []
  ...
  slot0(): UniswapV3Pair__slot0Result {
    const result = super.call(
      "slot0",
  ...
  try_slot0(): ethereum.CallResult<UniswapV3Pair__slot0Result> {
    const result = super.tryCall(
      "slot0",
      "slot0():(uint160,int24,uint16,uint16,uint16,uint8,bool)",
      []
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV3Pair__slot0Result(
        value[0].toBigInt(),
        value[1].toI32(),
        value[2].toI32(),
        value[3].toI32(),
  ...
  tickSpacing(): i32 {
    const result = super.call("tickSpacing", "tickSpacing():(int24)", []);

    return result[0].toI32();
  }

  try_tickSpacing(): ethereum.CallResult<i32> {
    const result = super.tryCall("tickSpacing", "tickSpacing():(int24)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  ticks(param0: i32): UniswapV3Pair__ticksResult {
    const result = super.call(
      "ticks",
  ...
  try_ticks(param0: i32): ethereum.CallResult<UniswapV3Pair__ticksResult> {
    const result = super.tryCall(
      "ticks",
      "ticks(int24):(uint128,int128,uint256,uint256,int56,uint160,uint32,bool)",
      [ethereum.Value.fromI32(param0)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV3Pair__ticksResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
