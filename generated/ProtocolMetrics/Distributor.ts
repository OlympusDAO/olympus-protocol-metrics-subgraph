...
export class Distributor extends ethereum.SmartContract {
  ...
  distribute(): boolean {
    const result = super.call("distribute", "distribute():(bool)", []);

    return result[0].toBoolean();
  }

  try_distribute(): ethereum.CallResult<boolean> {
    const result = super.tryCall("distribute", "distribute():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  epochLength(): BigInt {
    const result = super.call("epochLength", "epochLength():(uint256)", []);

    return result[0].toBigInt();
  }

  try_epochLength(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("epochLength", "epochLength():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  info(param0: BigInt): Distributor__infoResult {
    const result = super.call("info", "info(uint256):(uint256,address)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
  ...
  try_info(param0: BigInt): ethereum.CallResult<Distributor__infoResult> {
    const result = super.tryCall("info", "info(uint256):(uint256,address)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  nextEpochBlock(): BigInt {
    const result = super.call("nextEpochBlock", "nextEpochBlock():(uint256)", []);
  ...
  nextRewardAt(_rate: BigInt): BigInt {
    const result = super.call("nextRewardAt", "nextRewardAt(uint256):(uint256)", [
