...
export class sOlympusERC20V3 extends ethereum.SmartContract {
  ...
  debtBalances(param0: Address): BigInt {
    let result = super.call("debtBalances", "debtBalances(address):(uint256)", [
  ...
  fromG(amount: BigInt): BigInt {
    let result = super.call("fromG", "fromG(uint256):(uint256)", [
  ...
  try_fromG(amount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("fromG", "fromG(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(amount)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  toG(amount: BigInt): BigInt {
    let result = super.call("toG", "toG(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(amount)
    ]);
  ...
  try_toG(amount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("toG", "toG(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(amount)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
