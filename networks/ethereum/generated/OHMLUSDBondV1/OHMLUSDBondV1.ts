...
export class OHMLUSDBondV1__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMLUSDBondV1__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMLUSDBondV1__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMLUSDBondV1 extends ethereum.SmartContract {
  static bind(address: Address): OHMLUSDBondV1 {
    return new OHMLUSDBondV1("OHMLUSDBondV1", address);
  }
  ...
  adjustment(): OHMLUSDBondV1__adjustmentResult {
    ...
    return new OHMLUSDBondV1__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<OHMLUSDBondV1__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new OHMLUSDBondV1__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): OHMLUSDBondV1__bondInfoResult {
    const result = super.call(
      "bondInfo",
    ...
    return new OHMLUSDBondV1__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<OHMLUSDBondV1__bondInfoResult> {
    const result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new OHMLUSDBondV1__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  terms(): OHMLUSDBondV1__termsResult {
    const result = super.call(
      "terms",
    ...
    return new OHMLUSDBondV1__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<OHMLUSDBondV1__termsResult> {
    const result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new OHMLUSDBondV1__termsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
