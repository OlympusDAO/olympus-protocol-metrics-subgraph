...
export class OlympusStakingV3 extends ethereum.SmartContract {
  ...
  forfeit(): BigInt {
    const result = super.call("forfeit", "forfeit():(uint256)", []);

    return result[0].toBigInt();
  }

  try_forfeit(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("forfeit", "forfeit():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  rebase(): BigInt {
    const result = super.call("rebase", "rebase():(uint256)", []);

    return result[0].toBigInt();
  }

  try_rebase(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("rebase", "rebase():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  supplyInWarmup(): BigInt {
    const result = super.call("supplyInWarmup", "supplyInWarmup():(uint256)", []);
