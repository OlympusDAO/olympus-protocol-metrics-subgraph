...
export class VeFXS extends ethereum.SmartContract {
  ...
  locked__end(_addr: Address): BigInt {
    const result = super.call("locked__end", "locked__end(address):(uint256)", [
      ethereum.Value.fromAddress(_addr)
    ]);
  ...
  totalSupply1(t: BigInt): BigInt {
    const result = super.call("totalSupply", "totalSupply(uint256):(uint256)", [
  ...
  totalFXSSupply(): BigInt {
    const result = super.call("totalFXSSupply", "totalFXSSupply():(uint256)", []);
  ...
  supply(): BigInt {
    const result = super.call("supply", "supply():(uint256)", []);

    return result[0].toBigInt();
  }

  try_supply(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("supply", "supply():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  locked(arg0: Address): VeFXS__lockedResult {
    const result = super.call("locked", "locked(address):(int128,uint256)", [
  ...
  try_locked(arg0: Address): ethereum.CallResult<VeFXS__lockedResult> {
    const result = super.tryCall("locked", "locked(address):(int128,uint256)", [
      ethereum.Value.fromAddress(arg0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  epoch(): BigInt {
    const result = super.call("epoch", "epoch():(uint256)", []);

    return result[0].toBigInt();
  }

  try_epoch(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("epoch", "epoch():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  controller(): Address {
    const result = super.call("controller", "controller():(address)", []);

    return result[0].toAddress();
  }

  try_controller(): ethereum.CallResult<Address> {
    const result = super.tryCall("controller", "controller():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
