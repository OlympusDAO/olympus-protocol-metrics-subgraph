...
export class MasterChef extends ethereum.SmartContract {
  ...
  bonusEndBlock(): BigInt {
    const result = super.call("bonusEndBlock", "bonusEndBlock():(uint256)", []);
  ...
  devaddr(): Address {
    const result = super.call("devaddr", "devaddr():(address)", []);

    return result[0].toAddress();
  }

  try_devaddr(): ethereum.CallResult<Address> {
    const result = super.tryCall("devaddr", "devaddr():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  migrator(): Address {
    const result = super.call("migrator", "migrator():(address)", []);

    return result[0].toAddress();
  }

  try_migrator(): ethereum.CallResult<Address> {
    const result = super.tryCall("migrator", "migrator():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  startBlock(): BigInt {
    const result = super.call("startBlock", "startBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_startBlock(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("startBlock", "startBlock():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  sushi(): Address {
    const result = super.call("sushi", "sushi():(address)", []);

    return result[0].toAddress();
  }

  try_sushi(): ethereum.CallResult<Address> {
    const result = super.tryCall("sushi", "sushi():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  sushiPerBlock(): BigInt {
    const result = super.call("sushiPerBlock", "sushiPerBlock():(uint256)", []);
