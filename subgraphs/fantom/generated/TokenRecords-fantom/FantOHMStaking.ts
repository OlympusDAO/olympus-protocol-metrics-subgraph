...
export class FantOHMStaking__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FantOHMStaking__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class FantOHMStaking extends ethereum.SmartContract {
  static bind(address: Address): FantOHMStaking {
    return new FantOHMStaking("FantOHMStaking", address);
  }
  ...
  epoch(): FantOHMStaking__epochResult {
    const result = super.call(
      "epoch",
    ...
    return new FantOHMStaking__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<FantOHMStaking__epochResult> {
    const result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint256,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new FantOHMStaking__epochResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  locker(): Address {
    const result = super.call("locker", "locker():(address)", []);

    return result[0].toAddress();
  }

  try_locker(): ethereum.CallResult<Address> {
    const result = super.tryCall("locker", "locker():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  totalBonus(): BigInt {
    const result = super.call("totalBonus", "totalBonus():(uint256)", []);

    return result[0].toBigInt();
  }

  try_totalBonus(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("totalBonus", "totalBonus():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  warmupContract(): Address {
    const result = super.call("warmupContract", "warmupContract():(address)", []);
  ...
  warmupInfo(param0: Address): FantOHMStaking__warmupInfoResult {
    const result = super.call(
      "warmupInfo",
    ...
    return new FantOHMStaking__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<FantOHMStaking__warmupInfoResult> {
    const result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new FantOHMStaking__warmupInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  warmupPeriod(): BigInt {
    const result = super.call("warmupPeriod", "warmupPeriod():(uint256)", []);

    return result[0].toBigInt();
  }

  try_warmupPeriod(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("warmupPeriod", "warmupPeriod():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
