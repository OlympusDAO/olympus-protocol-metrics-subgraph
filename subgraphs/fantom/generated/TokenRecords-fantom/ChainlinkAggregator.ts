...
export class ChainlinkAggregator extends ethereum.SmartContract {
  ...
  getLinkToken(): Address {
    const result = super.call("getLinkToken", "getLinkToken():(address)", []);

    return result[0].toAddress();
  }

  try_getLinkToken(): ethereum.CallResult<Address> {
    const result = super.tryCall("getLinkToken", "getLinkToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  try_latestConfigDetails(): ethereum.CallResult<
    ChainlinkAggregator__latestConfigDetailsResult
  > {
    const result = super.tryCall(
      "latestConfigDetails",
      "latestConfigDetails():(uint32,uint32,bytes16)",
  ...
  try_latestRoundData(): ethereum.CallResult<
    ChainlinkAggregator__latestRoundDataResult
  > {
    const result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
  ...
  try_latestTransmissionDetails(): ethereum.CallResult<
    ChainlinkAggregator__latestTransmissionDetailsResult
  > {
    const result = super.tryCall(
      "latestTransmissionDetails",
      "latestTransmissionDetails():(bytes16,uint32,uint8,int192,uint64)",
  ...
  try_validatorConfig(): ethereum.CallResult<
    ChainlinkAggregator__validatorConfigResult
  > {
    const result = super.tryCall(
      "validatorConfig",
      "validatorConfig():(address,uint32)",
