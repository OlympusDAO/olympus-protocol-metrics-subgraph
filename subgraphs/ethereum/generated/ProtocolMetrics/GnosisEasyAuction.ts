...
export class GnosisEasyAuction__auctionDataResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class GnosisEasyAuction__claimFromParticipantOrderResult {
  value0: BigInt;
  value1: BigInt;
...
export class GnosisEasyAuction extends ethereum.SmartContract {
  static bind(address: Address): GnosisEasyAuction {
    return new GnosisEasyAuction("GnosisEasyAuction", address);
  }
  ...
  auctionCounter(): BigInt {
    const result = super.call("auctionCounter", "auctionCounter():(uint256)", []);
  ...
  auctionData(param0: BigInt): GnosisEasyAuction__auctionDataResult {
    const result = super.call(
      "auctionData",
    ...
    return new GnosisEasyAuction__auctionDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_auctionData(
    param0: BigInt
  ): ethereum.CallResult<GnosisEasyAuction__auctionDataResult> {
    const result = super.tryCall(
      "auctionData",
      "auctionData(uint256):(address,address,uint256,uint256,bytes32,uint256,uint256,bytes32,bytes32,uint96,bool,bool,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new GnosisEasyAuction__auctionDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  claimFromParticipantOrder(
    auctionId: BigInt,
    orders: Array<Bytes>
  ): GnosisEasyAuction__claimFromParticipantOrderResult {
    const result = super.call(
      "claimFromParticipantOrder",
    ...
    return new GnosisEasyAuction__claimFromParticipantOrderResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_claimFromParticipantOrder(
    auctionId: BigInt,
    orders: Array<Bytes>
  ): ethereum.CallResult<GnosisEasyAuction__claimFromParticipantOrderResult> {
    const result = super.tryCall(
      "claimFromParticipantOrder",
      "claimFromParticipantOrder(uint256,bytes32[]):(uint256,uint256)",
      [
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new GnosisEasyAuction__claimFromParticipantOrderResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  feeNumerator(): BigInt {
    const result = super.call("feeNumerator", "feeNumerator():(uint256)", []);

    return result[0].toBigInt();
  }

  try_feeNumerator(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("feeNumerator", "feeNumerator():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  getUserId(user: Address): BigInt {
    const result = super.call("getUserId", "getUserId(address):(uint64)", [
  ...
  try_getUserId(user: Address): ethereum.CallResult<BigInt> {
    const result = super.tryCall("getUserId", "getUserId(address):(uint64)", [
      ethereum.Value.fromAddress(user)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  numUsers(): BigInt {
    const result = super.call("numUsers", "numUsers():(uint64)", []);

    return result[0].toBigInt();
  }

  try_numUsers(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("numUsers", "numUsers():(uint64)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  registerUser(user: Address): BigInt {
    const result = super.call("registerUser", "registerUser(address):(uint64)", [
      ethereum.Value.fromAddress(user)
    ]);
