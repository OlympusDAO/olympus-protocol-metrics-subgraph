...
LIQUIDITY_POOL_TOKEN_LOOKUP.set(ERC20_WSTETH, [new PairHandler(PairHandlerTypes.Balancer, BALANCER_VAULT, POOL_BALANCER_WSTETH_WETH_ID), new PairHandler(PairHandlerTypes.UniswapV3, PAIR_UNISWAP_V3_WETH_WSTETH)]);
