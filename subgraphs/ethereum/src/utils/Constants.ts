...
import { AAVE_ALLOCATOR, AAVE_ALLOCATOR_V2, AURA_ALLOCATOR, AURA_ALLOCATOR_V2, BALANCER_ALLOCATOR, BONDS_DEPOSIT, BONDS_INVERSE_DEPOSIT, BUYBACK_MS, CONVEX_ALLOCATOR1, CONVEX_ALLOCATOR2, CONVEX_ALLOCATOR3, CONVEX_CVX_ALLOCATOR, CONVEX_CVX_VL_ALLOCATOR, CONVEX_STAKING_PROXY_FRAXBP, CONVEX_STAKING_PROXY_OHM_FRAXBP, COOLER_LOANS_CLEARINGHOUSE_V1, COOLER_LOANS_CLEARINGHOUSE_V1_1, COOLER_LOANS_CLEARINGHOUSE_V2, COOLER_LOANS_V2_MONOCOOLER, CROSS_CHAIN_ARBITRUM, CROSS_CHAIN_FANTOM, CROSS_CHAIN_POLYGON, DAO_WALLET, DAO_WORKING_CAPITAL, LUSD_ALLOCATOR, MAKER_DSR_ALLOCATOR, MAKER_DSR_ALLOCATOR_PROXY, MYSO_LENDING, OLYMPUS_ASSOCIATION_WALLET, OTC_ESCROW, RARI_ALLOCATOR, TREASURY_ADDRESS_V1, TREASURY_ADDRESS_V2, TREASURY_ADDRESS_V3, TRSRY, TRSRY_V1_1, VEFXS_ALLOCATOR, VENDOR_LENDING, YIELD_FARMING_MS } from "../../../shared/src/Wallets";
...
export const ERC20_VARIABLE_DEBT_ETH_USDT = "0x6df1c1e379bc5a00a7b4c6e67a203333772f45a8".toLowerCase(); // Aave v3 variable debt USDT (yield farming loop liability)
export const ERC20_VARIABLE_DEBT_ETH_USDC = "0x72e95b8931767c79ba4eee721354d6e99a61d004".toLowerCase(); // Aave v3 variable debt USDC (yield farming loop liability)
...
ERC20_TOKENS.set(ERC20_AETH_SUSDE, new TokenDefinition(ERC20_AETH_SUSDE, TokenCategoryStable, true, false));
ERC20_TOKENS.set(ERC20_AETH_USDE, new TokenDefinition(ERC20_AETH_USDE, TokenCategoryStable, true, false));
// Debt tokens use liquidBackingMultiplier = -1 so their value subtracts from treasury backing (net neutral loop)
ERC20_TOKENS.set(ERC20_VARIABLE_DEBT_ETH_USDT, new TokenDefinition(ERC20_VARIABLE_DEBT_ETH_USDT, TokenCategoryStable, true, false, BigDecimal.fromString("-1")));
ERC20_TOKENS.set(ERC20_VARIABLE_DEBT_ETH_USDC, new TokenDefinition(ERC20_VARIABLE_DEBT_ETH_USDC, TokenCategoryStable, true, false, BigDecimal.fromString("-1")));
...
export const PAIR_UNISWAP_V3_WEETH_WETH = "0x202A6012894Ae5c288eA824cbc8A9bfb26A49b93".toLowerCase();
export const PAIR_UNISWAP_V3_WETH_OHM = "0x88051b0eea095007d3bef21ab287be961f3d8598".toLowerCase();
export const PAIR_UNISWAP_V3_WETH_WSTETH = "0x109830a1aaad605bbf02a9dfa7b0b92ec2fb7daa".toLowerCase();
...
LIQUIDITY_POOL_TOKEN_LOOKUP.set(ERC20_AETH_SUSDE, [new PairHandler(PairHandlerTypes.ERC4626, ERC4626_SUSDE)]);
...
LIQUIDITY_POOL_TOKEN_LOOKUP.set(ERC20_WEETH, [new PairHandler(PairHandlerTypes.UniswapV3, PAIR_UNISWAP_V3_WEETH_WETH)]);
...
const pairHandlerUniswapV3WethOhm = new PairHandler(
  PairHandlerTypes.UniswapV3, PAIR_UNISWAP_V3_WETH_OHM
);

const pairHandlerUniswapV3OhmSusds = new PairHandler(
  PairHandlerTypes.UniswapV3, PAIR_UNISWAP_V3_OHM_SUSDS
);

export const OHM_PRICE_PAIRS = [pairHandlerUniswapV2OhmDaiV2, pairHandlerBalancerOhmDaiEth, pairHandlerBalancerOhmDai, pairHandlerUniswapV3WethOhm, pairHandlerUniswapV3OhmSusds];
...
MYSO_DEPLOYMENTS.set(ERC20_DAI.toLowerCase(), [
  ...
  new LendingMarketDeployment(ERC20_DAI, BigInt.fromString("18185779"), BigDecimal.fromString("-28813.5151768475"), MYSO_LENDING), // Write-off
]);
