...
export const BALANCER_LIQUIDITY_GAUGES = [BALANCER_LIQUIDITY_GAUGE_WETH_FDT, BALANCER_LIQUIDITY_GAUGE_OHM_DAI_WETH, BALANCER_LIQUIDITY_GAUGE_OHM_WETH];
...
export const AURA_STAKING_OHM_WETH = "0xB9D6ED734Ccbdd0b9CadFED712Cf8AC6D0917EcD".toLowerCase();
