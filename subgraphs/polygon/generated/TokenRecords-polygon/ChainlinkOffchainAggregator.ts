...
export class ChainlinkOffchainAggregator__getBillingResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkOffchainAggregator__getRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkOffchainAggregator__latestConfigDetailsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Bytes;
...
export class ChainlinkOffchainAggregator__latestRoundDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class ChainlinkOffchainAggregator__latestTransmissionDetailsResult {
  value0: Bytes;
  value1: BigInt;
  value2: i32;
  value3: BigInt;
...
export class ChainlinkOffchainAggregator__validatorConfigResult {
  value0: Address;
  value1: BigInt;
...
export class ChainlinkOffchainAggregator extends ethereum.SmartContract {
  static bind(address: Address): ChainlinkOffchainAggregator {
    return new ChainlinkOffchainAggregator(
      "ChainlinkOffchainAggregator",
      address
    );
  }

  LINK(): Address {
    const result = super.call("LINK", "LINK():(address)", []);

    return result[0].toAddress();
  }

  try_LINK(): ethereum.CallResult<Address> {
    const result = super.tryCall("LINK", "LINK():(address)", []);
    if (result.reverted) {
  ...
  checkEnabled(): boolean {
    const result = super.call("checkEnabled", "checkEnabled():(bool)", []);

    return result[0].toBoolean();
  }

  try_checkEnabled(): ethereum.CallResult<boolean> {
    const result = super.tryCall("checkEnabled", "checkEnabled():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  description(): string {
    const result = super.call("description", "description():(string)", []);

    return result[0].toString();
  }

  try_description(): ethereum.CallResult<string> {
    const result = super.tryCall("description", "description():(string)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  getAnswer(_roundId: BigInt): BigInt {
    const result = super.call("getAnswer", "getAnswer(uint256):(int256)", [
  ...
  try_getAnswer(_roundId: BigInt): ethereum.CallResult<BigInt> {
    const result = super.tryCall("getAnswer", "getAnswer(uint256):(int256)", [
      ethereum.Value.fromUnsignedBigInt(_roundId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getBilling(): ChainlinkOffchainAggregator__getBillingResult {
    const result = super.call(
      "getBilling",
    ...
    return new ChainlinkOffchainAggregator__getBillingResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getBilling(): ethereum.CallResult<
    ChainlinkOffchainAggregator__getBillingResult
  > {
    const result = super.tryCall(
      "getBilling",
      "getBilling():(uint32,uint32,uint32,uint32,uint32)",
    ...
    return ethereum.CallResult.fromValue(
      new ChainlinkOffchainAggregator__getBillingResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getRoundData(
    _roundId: BigInt
  ): ChainlinkOffchainAggregator__getRoundDataResult {
    const result = super.call(
      "getRoundData",
    ...
    return new ChainlinkOffchainAggregator__getRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getRoundData(
    _roundId: BigInt
  ): ethereum.CallResult<ChainlinkOffchainAggregator__getRoundDataResult> {
    const result = super.tryCall(
      "getRoundData",
      "getRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)]
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOffchainAggregator__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getTimestamp(_roundId: BigInt): BigInt {
    const result = super.call("getTimestamp", "getTimestamp(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_roundId)
    ]);
  ...
  hasAccess(_user: Address, _calldata: Bytes): boolean {
    const result = super.call("hasAccess", "hasAccess(address,bytes):(bool)", [
  ...
  try_hasAccess(
    ...
    const result = super.tryCall("hasAccess", "hasAccess(address,bytes):(bool)", [
      ethereum.Value.fromAddress(_user),
      ethereum.Value.fromBytes(_calldata)
    ]);
    if (result.reverted) {
  ...
  latestAnswer(): BigInt {
    const result = super.call("latestAnswer", "latestAnswer():(int256)", []);

    return result[0].toBigInt();
  }

  try_latestAnswer(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("latestAnswer", "latestAnswer():(int256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  latestConfigDetails(): ChainlinkOffchainAggregator__latestConfigDetailsResult {
    const result = super.call(
      "latestConfigDetails",
    ...
    return new ChainlinkOffchainAggregator__latestConfigDetailsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBytes()
    );
  ...
  try_latestConfigDetails(): ethereum.CallResult<
    ChainlinkOffchainAggregator__latestConfigDetailsResult
  > {
    const result = super.tryCall(
      "latestConfigDetails",
      "latestConfigDetails():(uint32,uint32,bytes16)",
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOffchainAggregator__latestConfigDetailsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBytes()
      )
  ...
  latestRound(): BigInt {
    const result = super.call("latestRound", "latestRound():(uint256)", []);

    return result[0].toBigInt();
  }

  try_latestRound(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("latestRound", "latestRound():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  latestRoundData(): ChainlinkOffchainAggregator__latestRoundDataResult {
    const result = super.call(
      "latestRoundData",
    ...
    return new ChainlinkOffchainAggregator__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(): ethereum.CallResult<
    ChainlinkOffchainAggregator__latestRoundDataResult
  > {
    const result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOffchainAggregator__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestTransmissionDetails(): ChainlinkOffchainAggregator__latestTransmissionDetailsResult {
    const result = super.call(
    ...
    return new ChainlinkOffchainAggregator__latestTransmissionDetailsResult(
      result[0].toBytes(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBigInt(),
  ...
  try_latestTransmissionDetails(): ethereum.CallResult<
    ChainlinkOffchainAggregator__latestTransmissionDetailsResult
  > {
    const result = super.tryCall(
      "latestTransmissionDetails",
      "latestTransmissionDetails():(bytes16,uint32,uint8,int192,uint64)",
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOffchainAggregator__latestTransmissionDetailsResult(
        value[0].toBytes(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBigInt(),
  ...
  maxAnswer(): BigInt {
    const result = super.call("maxAnswer", "maxAnswer():(int192)", []);

    return result[0].toBigInt();
  }

  try_maxAnswer(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("maxAnswer", "maxAnswer():(int192)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  minAnswer(): BigInt {
    const result = super.call("minAnswer", "minAnswer():(int192)", []);

    return result[0].toBigInt();
  }

  try_minAnswer(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("minAnswer", "minAnswer():(int192)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  owedPayment(_transmitter: Address): BigInt {
    const result = super.call("owedPayment", "owedPayment(address):(uint256)", [
  ...
  transmitters(): Array<Address> {
    const result = super.call("transmitters", "transmitters():(address[])", []);
  ...
  typeAndVersion(): string {
    const result = super.call("typeAndVersion", "typeAndVersion():(string)", []);
  ...
  validatorConfig(): ChainlinkOffchainAggregator__validatorConfigResult {
    const result = super.call(
      "validatorConfig",
    ...
    return new ChainlinkOffchainAggregator__validatorConfigResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_validatorConfig(): ethereum.CallResult<
    ChainlinkOffchainAggregator__validatorConfigResult
  > {
    const result = super.tryCall(
      "validatorConfig",
      "validatorConfig():(address,uint32)",
    ...
    const value = result.value;
    return ethereum.CallResult.fromValue(
      new ChainlinkOffchainAggregator__validatorConfigResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
