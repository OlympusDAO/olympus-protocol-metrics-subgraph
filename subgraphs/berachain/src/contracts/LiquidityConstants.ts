...
export const PRICE_HANDLERS: PriceHandler[] = [
  ...
  new PriceHandlerUniswapV3Quoter([ERC20_IBERA, ERC20_WBERA], KODIAK_QUOTER, LP_KODIAK_IBERA_WBERA_3000, getContractName),
  new PriceHandlerUniswapV3Quoter([ERC20_IBERA, ERC20_WBERA], KODIAK_QUOTER, LP_KODIAK_IBERA_WBERA_500, getContractName),
  kodiakOhmHoney,
