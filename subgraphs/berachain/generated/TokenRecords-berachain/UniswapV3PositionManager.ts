...
export class UniswapV3PositionManager__positionsResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class UniswapV3PositionManager extends ethereum.SmartContract {
  static bind(address: Address): UniswapV3PositionManager {
    return new UniswapV3PositionManager("UniswapV3PositionManager", address);
  }
  ...
  baseURI(): string {
    const result = super.call("baseURI", "baseURI():(string)", []);

    return result[0].toString();
  }

  try_baseURI(): ethereum.CallResult<string> {
    const result = super.tryCall("baseURI", "baseURI():(string)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  positions(tokenId: BigInt): UniswapV3PositionManager__positionsResult {
    const result = super.call(
      "positions",
    ...
    return new UniswapV3PositionManager__positionsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_positions(
    tokenId: BigInt,
  ): ethereum.CallResult<UniswapV3PositionManager__positionsResult> {
    const result = super.tryCall(
      "positions",
      "positions(uint256):(uint96,address,address,address,uint24,int24,int24,uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)],
    ...
    return ethereum.CallResult.fromValue(
      new UniswapV3PositionManager__positionsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toAddress(),
